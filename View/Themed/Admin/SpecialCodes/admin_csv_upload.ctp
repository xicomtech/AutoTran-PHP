<div class="users row">
    <div class="floatleft mtop10"><h1><?php echo __('Add special code'); ?></h1></div>
    <div class="floatright">
        <?php
	echo $this->Html->link('<span>'.__('Back To Manage Special Codes').'</span>', array('controller' => 'special_codes','action' => 'index','admin' => true),array('class'=>'black_btn','escape'=>false));?>
	</div>
	<div class="errorMsg"><?php echo $this->element('validations'); ?></div>
</div>

<div align="center" class="whitebox mtop15">
    <?php echo $this->Form->create('SpecialCode',array('type'=>'file'));?>
