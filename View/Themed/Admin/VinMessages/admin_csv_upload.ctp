<div class="users row">
    <div class="floatleft mtop10"><h1><?php echo __('Add vin messages'); ?></h1></div>
    <div class="floatright">
        <?php
	echo $this->Html->link('<span>'.__('Back To Manage vin messages').'</span>', array('controller' => 'vin_messages','action' => 'index','admin' => true),array('class'=>'black_btn','escape'=>false));?>
	</div>
	<div class="errorMsg"><?php echo $this->element('validations'); ?></div>
</div>

<div align="center" class="whitebox mtop15">
    <?php echo $this->Form->create('VinMessage',array('type'=>'file'));?>
