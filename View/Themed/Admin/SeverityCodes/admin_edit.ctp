<div class="users row">
    <div class="floatleft mtop10"><h1><?php echo __('Edit severity code'); ?></h1></div>
    <div class="floatright">
        <?php
	echo $this->Html->link('<span>'.__('Back To Manage Severity code').'</span>', array('controller' => 'severity_codes','action' => 'index','admin' => true),array('class'=>'black_btn','escape'=>false));?>
	</div>
	<div class="errorMsg"><?php echo $this->element('validations'); ?></div>
</div>

<div align="center" class="whitebox mtop15">
    <?php echo $this->Form->create('SeverityCode');?>
    ...
    <table cellspacing="0" cellpadding="7" border="0" align="center">
		...
		<tr>
			...
			<td align="left">	
				<?php
					echo $this->Form->input('code',array('type'=>'text','class' => 'input required', 'label' => false, 'legend' => false, 'error' => false, 'div' => false, 'style'=>'width: 450px;'));
				?>
			</td>
		</tr>
		<tr>
